...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    setError("");
    setIsLoading(true);
    const result = isVerificationStep
      ? await verifySignup(email, otp)
      : await signup(businessName, email, password, instagramLink);
    setIsLoading(false);
    if (result.success) {
            ...
            <>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg text-center tracking-[0.4em] focus:ring-2 focus:ring-gray-500 focus:border-transparent outline-none transition"
                  placeholder="000000"
                  maxLength={6}
                  required
                />
